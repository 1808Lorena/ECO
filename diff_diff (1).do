...
global main "/Users/ar8787/Downloads"
...
*pon 0 en esa cariable si hay valores nulos
*efetyear  año en q empezo tratamiento


csdid l_assault ${xvar} [iw=popwt], ivar(sid) time(year) gvar(effyear) method(reg) notyet
estat simple

*permite generar estimacion a nivel d grupos
*anteriores regresiones asumen q tratamiento sea antes o dsps no tiene efecto. tratamiento q sucedio antes o dsps le da mismo pese. pero probaron dsps q no es asi. son betas sesgados. cc tratamos d converger este beta, cc n tiende a infinito, beta no se aproxima a su media, entonces valor esperado d beta estimado, si lo corriamos miles d veces, no estaria cerca d su valor real. 
*x construccion estaria mal. es xq le das pesos iguales a cada uno
*se da peso a nivel d indiivduo y a nivel d año en un dif and dif normal, pero no debe ser asi aqui
*lo q tiene menos personas o tiempo deberia tener menos peso
*ESTA ES LA FORMA CORRECTA D ESTIMAR 
*Ej en pension65
...
*estima si gurpo control y tratado son iguales a 0
*si tratado y control antes d tratamiento eran similares
*se rechaza hip nula q es igual, entonces si son distintos antes d ser tratados entonces dificil q pueda limpiar diferencia
